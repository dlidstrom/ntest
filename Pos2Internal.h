...
int ValidMove(bool fBlackMove, int square);
...
#ifdef OLD
inline int CalcMobility(u4& nMovesPlayer, u4& nMovesOpponent, CMoves& moves) {
   return bb.CalcMobility(nMovesPlayer,nMovesOpponent, moves);
}
#endif
